        ...
        <div className="bg-[var(--color-surface)] border border-[var(--color-border)] rounded-2xl px-6 sm:px-8 py-8">
          <form className="flex flex-col gap-6">
            ...
            <div className={fieldCls}>
              ...
              <input id="title" type="text" defaultValue="Full-Stack Web Dev Workshop" className={inputCls} />
            </div>
            ...
            <div className={fieldCls}>
              ...
              <textarea
                id="description"
                rows={5}
                defaultValue="A full-day hands-on workshop covering modern full-stack development. Participants will build and deploy a complete web application using React, Node.js, and cloud hosting."
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className={fieldCls}>
                ...
                <select id="category" defaultValue="Workshop" className={`${inputCls} cursor-pointer`}>
              ...
              <div className={fieldCls}>
                ...
                <select id="event-type" defaultValue="In-person" className={`${inputCls} cursor-pointer`}>
            ...
            <div className={fieldCls}>
              ...
              <input id="venue" type="text" defaultValue="Tech Hub, Lahore" className={inputCls} />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className={fieldCls}>
                ...
                <input id="event-date" type="date" defaultValue="2026-07-12" className={inputCls} />
              </div>
              <div className={fieldCls}>
                <label className={labelCls} htmlFor="event-time">Time</label>
                <input id="event-time" type="time" defaultValue="10:00" className={inputCls} />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className={fieldCls}>
                ...
                <input id="capacity" type="number" min={1} defaultValue={60} className={inputCls} />
              </div>
              <div className={fieldCls}>
                <label className={labelCls} htmlFor="deadline">Registration deadline</label>
                <input id="deadline" type="date" defaultValue="2026-07-10" className={inputCls} />
              </div>
            </div>
            ...
            <div className={fieldCls}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 mt-1">
                {[
                  { id: "auto",   value: "auto",   label: "Auto approval",  desc: "Registrations are approved instantly",          checked: false },
                  { id: "manual", value: "manual", label: "Manual approval", desc: "You review and approve each registration",      checked: true  },
                ].map(({ id, value, label, desc, checked }) => (
                  <label
                    key={id}
                    htmlFor={id}
                    className="
